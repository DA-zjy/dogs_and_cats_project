...
from torchvision.models import resnet34 # <<< 直接从 torchvision 导入
...
def predict_from_scratch():
    ...
    # 1. 定义你的最佳模型的路径
    MODEL_PATH = f"{config.CHECKPOINT_PATH}/dogs_and_cats_epoch_24.pth"
    ...
    # 4. 加载你训练好的最佳模型权重
    print(f"正在加载模型: {config.CHECKPOINT_PATH}/dogs_and_cats_epoch_24.pth")
